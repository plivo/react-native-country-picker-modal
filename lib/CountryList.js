...
const CountryItem = (props) => {
    ...
    const { country, onSelect, withFlag, withEmoji, withCallingCode, withCurrency, fontStyle, } = props;
    const extraContent = [];
    if (withCallingCode &&
        country.callingCode &&
...
export const CountryList = (props) => {
    const { data, withAlphaFilter, withEmoji, withFlag, withCallingCode, withCurrency, onSelect, filter, flatListProps, filterFocus, fontStyle, } = props;
