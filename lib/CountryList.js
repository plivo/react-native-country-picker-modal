...
const CountryItem = (props) => {
    ...
    const { country, onSelect, withFlag, withEmoji, withCallingCode, withCurrency, fontSyle, } = props;
    const extraContent = [];
    if (withCallingCode &&
        country.callingCode &&
    ...
    return (React.createElement(TouchableOpacity, Object.assign({ key: country.cca2, testID: `country-selector-${country.cca2}`, onPress: () => onSelect(country) }, { activeOpacity }),
        React.createElement(View, { style: [styles.itemCountry, { height: itemHeight }] },
            ...
            React.createElement(View, { style: styles.itemCountryName },
                React.createElement(CountryText, { allowFontScaling: false, numberOfLines: 2, ellipsizeMode: 'tail', fontSyle: fontSyle },
                    country.name,
...
export const CountryList = (props) => {
    const { data, withAlphaFilter, withEmoji, withFlag, withCallingCode, withCurrency, onSelect, filter, flatListProps, filterFocus, fontSyle, } = props;
